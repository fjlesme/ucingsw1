...
| Unidad | Tema | Presentación | Ejercitario | Fecha Limite de Commits |
|---|---|---|---|---|
| 1 | Ingeniería de software: una visión previa | [Ver .pptx](presentaciones/Ingenieria_de_Software_Vision_Previa.pptx) | [Ver .docx](ejercitarios/unidad-01-ejercitario.docx) | 21/09/2026 15:00 |
| 2 | Software: su naturaleza y sus cualidades | [Ver .pptx](presentaciones/unidad-02-software-naturaleza-cualidades.pptx) | [Ver .docx](ejercitarios/unidad-02-ejercitario.docx) |  24/09/2026 20:00 |
| 3 | Principios de la ingeniería de software | [Ver .pptx](presentaciones/unidad-03-presentacion.pptx) | [Ver .docx](ejercitarios/unidad-03-ejercitario.docx) |  28/09/2026 15:00 |
| 4 | Diseño del software | [Ver .pptx](presentaciones/unidad-04-presentacion.pptx) | [Ver .md](ejercitarios/unidad-04-ejercitario.md) | 01/10/2026 15:00 |
...
El Trabajo Práctico se realiza en grupos y se entrega en tres instancias: **Conceptualización**, **Análisis** y **Diseño**, publicadas en un sitio de GitHub Pages propio de cada grupo (no se entregan archivos impresos ni sueltos).

- 📋 [Consigna completa del TP](trabajo-practico/guia-trabajo-practico.docx)
- 📦 [Plantilla base para el repositorio del grupo](trabajo-practico/plantilla-repositorio-grupo.zip) — estructura lista con README, `/docs` para GitHub Pages y plantillas de las 3 entregas.

### Cómo entregan los grupos

1. Cada grupo crea **su propio repositorio** (no suben nada a este repositorio).
2. Usan la plantilla de arriba como punto de partida y publican su sitio en GitHub Pages.
3. Agregan su grupo a la tabla de abajo mediante un **Pull Request** (ver instrucciones en [CONTRIBUTING.md](CONTRIBUTING.md)).
4. Entregan el link de su sitio antes de la fecha límite de cada instancia.
